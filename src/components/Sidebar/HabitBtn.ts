export default function HabitBtn(calendarNum: number, calendarTitle: string) {
  return `
  <div class="sidebar-habit h-14 cursor-pointer items-center justify-center transition duration-300 hover:bg-slate-200 md:flex md:w-14 text-2xl relative group">
