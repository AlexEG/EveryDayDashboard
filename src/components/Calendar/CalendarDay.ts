export default function renderDayBtn(month: string, day: number): string {
  ...
  <!-- ${month}-[${day}] -->
      <div class="w-20 h-20 flex justify-center items-end relative">
              <div
                class="absolute top-0.5 bg-gold2 w-3 h-3 rounded-full left-4 opacity-10"></div>
              <div
                class="absolute top-0.5 bg-gold2 w-3 h-3 rounded-full right-4 opacity-10"></div>
              <div
                class="absolute top-5 bg-gold2 w-2 h-2 rounded-full right-1 opacity-10"></div>
              <div
                class="absolute top-5 bg-gold2 w-2 h-2 rounded-full left-1 opacity-10"></div>
              <div
                class="absolute bottom-1 bg-gold2 w-2 h-2 rounded-full right-1 opacity-10"></div>
              <div
                class="absolute bottom-1 bg-gold2 w-2 h-2 rounded-full left-1 opacity-10"></div>
              <button id="${month}-${day}"
                  ...
                  <div
                    ...
                    <div
                      ...
                      <div
                        ...
                        <span
                          class="text-white font-semibold text-center text-xl transition duration-300">
                          ${day}
                        </span>
                      </div>
                    </div>
